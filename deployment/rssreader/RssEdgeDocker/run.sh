java -jar KiekerLogPusher/KiekerLogPusher.jar "$HOSTNAME" /tmp/ 172.16.22.5:8086 k8sfp kiekerlogs &
java -jar lib/K8sFpFaultController-0.0.1-SNAPSHOT-jar-with-dependencies.jar "$HOSTNAME" 172.16.22.5:8086 k8sfp 60000 &
